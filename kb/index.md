---
title: Suite Accounts knowledge base
aliases:
...
This Git-backed Markdown vault is durable memory for Suite Accounts. Open `kb/` itself as the vault. Markdown and Git are authoritative. Catalogs, backlinks, graph views, semantic indexes, repository context, and Git projections are derived.
