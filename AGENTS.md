...
- Keep the currently live frozen v1 registry byte- and behavior-compatible for released clients. Preserve the published v1 browser coordination strings, reject retired client identities, mark the compatibility registry deprecated, add no new consumer through it, and put all new use through the validated factory.
