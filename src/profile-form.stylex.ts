...
const styles = stylex.create({
  ...
  affix: {
    ...
    display: "flex",
    minWidth: 0,
    opacity: { default: null, ":has(:disabled)": 0.6 },
    outlineColor: { default: null, ":focus-within": "var(--suite-profile-focus, currentColor)" },
...
export const profileFormClasses = {
  affix: stylex.props(styles.affix).className,
  affixInput: stylex.props(styles.affixInput).className,
  affixLead: stylex.props(styles.affixLead).className,
  ...
  links: stylex.props(styles.links).className,
  linksBody: stylex.props(styles.linksBody).className,
  linksHint: stylex.props(styles.linksHint).className,
  linksSummary: stylex.props(styles.linksSummary).className,
